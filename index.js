...
const info = [
  ...
  "80% of the stuff in the universe is dark matter, and we can only see it from it's gravitational pull.",
  "To drive a car from one end of the Milky Way galaxy to the other, you'd need to convert about 50x all the life on Earth into gasoline.",
  "Shortly after the big bang, the entire universe was about a thousand times smoother than a bowling ball.",
  "Stars don't actually twinkle. Instead, the air on the Earth moves and distorts the light.",
  "In four billion years our Sun will be dying, Earth will no longer be habitable, and our Milky Way galaxy will be colliding with Andromeda.",
  "The biggest volcano in the Solar system is 'Olympus Mons' on Mars. It's 22 Km high and would cover most of France.",
  "Astronomers have found almost 5000 planets outside of the Solar system.",
  "Black holes have such strong gravity that even light can't escape from them. That's why they're black.",
  "The Moon and the Earth used to be one planet.",
  "100 billion solar neutrinos passed through every square centimeter of you before you finished reading this",
...
async function fetchInfo() {
  ...
  const { data } = await axios.get(infoFetchUrl)
  storage.setObj('info', data)
}
...
function showRandomInfo() {
  ...
  body.appendChild(el)
  const info = storage.getObj('info')
